          ...
          <div className="animate-fade-up-delay-1 order-1 lg:order-2">
            <div className="glass-card-hero p-6 sm:p-8 lg:p-10">
              ...
              <p className="text-base sm:text-lg text-muted-foreground mb-8 leading-relaxed">
                Няма да харчите нищо за да увеличите броя на Google Maps отзивите! С нашата безплатна услуга, генерирате два персонализирани шаблона - A5 плакат и A4 лист с 9 мини карти - за 30 секунди. Пакетите за доставка и визитките за клиентите ви ще бъдат с QR кодове, които ще ви позволят да получите отзиви директно от телефоните на клиентите ви. Безплатно завинаги, без договори и без кредитна карта!
              </p>
