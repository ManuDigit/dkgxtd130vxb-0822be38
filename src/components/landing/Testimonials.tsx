...
const testimonials = [
  {
    quote: "Открих този фантастичен безплатен QR код генератор на OtziviPro.bg! Печатам А5 плакати с QR кодове и ги прилепявам на пакетите за доставка. Клиентите сканират веднага след покупка и оставят Google ревюта директно от телефона. Визитките раздавам на пазари и получавам удвоени ревюта без никакви разходи!",
    author: "Мария Д.",
