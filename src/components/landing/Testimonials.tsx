...
const testimonials = [
  {
    quote: "Този безплатен QR код генератор на OtziviPro.bg е невероятен! Печатам A5 плакатите с QR и ги слагам на огледалата в салона – клиентките сканират след подстригване и оставят Google ревюта на момента. Визитките давам на излизане с напомняне; резултатът е десетки нови 5-звездни отзиви месечно, без никакви такси!",
    author: "Мария Д.",
